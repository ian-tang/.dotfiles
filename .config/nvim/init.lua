...
-- Center the view on the cursor after <C-u> and <C-d>
...
-- Resize splits more than 1 column/row at a time
vim.keymap.set("n", "<C-w>+", "<C-w>5+", { desc = "Increase window height by 5 columns" })
vim.keymap.set("n", "<C-w>-", "<C-w>5-", { desc = "Decrease window height by 5 columns" })
vim.keymap.set("n", "<C-w>>", "<C-w>10>", { desc = "Increase window width by 10 columns" })
vim.keymap.set("n", "<C-w><", "<C-w>10<", { desc = "Decrease window width by 10 columns" })
...
vim.api.nvim_create_autocmd("BufEnter", {
	desc = "Prevent automatic insertion of comment leaders",
	group = vim.api.nvim_create_augroup("disable-comment-continue", { clear = true }),
	once = true,
	pattern = "*",
		...
		config = function()
			...
			require("telescope").setup({
				...
				defaults = {
					...
					-- switch between horizontal and vertical based on window width
			...
			-- Search all files in the dev directory
			vim.keymap.set("n", "<leader>sa", function()
				builtin.find_files({ search_dirs = { "~/dev" } })
			end, { desc = "[S]earch [A]ll files in dev dir" })

			-- Easter egg?!
			-- vim.keymap.set("n", "<leader>se", function()
			-- 	builtin.planets({ show_pluto = true, show_moon = true })
			-- end, { desc = "[S]earch [E]aster eggs" })
